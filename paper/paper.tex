...
\KwResult{Basis vectors of the low-dimensional calibration space $g_k(\lambda,m)$, location of exposures in this space $a_{n,k}$}
...
\begin{figure}[t]
\centering
\includegraphics[width=.65\textwidth]{Figures/kvals_all.pdf}
