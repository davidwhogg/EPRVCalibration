...
\KwResult{Wavelengths for detector positions $x'(m,n')$ of exposure $n'$ with time $t_{n'}$, where the prime is used to denote values relevant to this new exposure}
