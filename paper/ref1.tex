...
%DIF ADD paper.tex    Mon Oct 19 09:47:10 2020
...
A reduction in RMS was observed universally in all data sets tested; other data sets showed a reduction in RMS between $0.2-0.5\, \mps$.
}\DIFdelend \DIFaddbegin \DIFadd{$0.52\, \mps \,(=\sqrt{1.17^2-1.05^2})$.
}\DIFaddend 
...
For the dimensionality reduction and denoising, the PCA could be replaced by a probabilistic PCA model or other probabilistic linear reduction methods, such as heteroscedastic matrix factorization (HMF)\citep{tsalmantza2012}.  It is also possible to move to non-linear reduction methods, like an auto-encoder or a normalizing flow \citep[e.g.][]{kramer1991,woodbridge2020}\DIFaddbegin \DIFadd{.  Careful choice in the denoising model could enable \name\ to capture large-scale changes as well as small variations in calibration state.  This would bridge data broken up by significant format changes (e.g. replacing hardware, opening the spectrograph chamber, etc.).
}\DIFaddend 
